...
namespace Dominio.Viaticos.Servicios
{
    public class ViaticosMapperServices : MapperServices
    {
        public override void Maping(IAplicacion app)
        {
            ...
            app.Register<IServicioAutorizacionViaticos<Entidades.SolicitudCondensada, Entidades.Autorizacion,Entidades.FlujoViatico,Entidades.PasoViatico>, ServicioAutorizacionViaticos>();
